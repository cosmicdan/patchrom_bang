...
.field private static final default_alarm_vol:I

.field private static final default_music_vol:I

.field private static final default_notification_vol:I

.field private static final default_ring_vol:I

.field private static final default_voice_call:I
...
.method static constructor <clinit>()V
    ...
    const-string/jumbo v0, "ro.init.ringtone_vol"

    invoke-static {v0, v3}, Landroid/os/SystemProperties;->getInt(Ljava/lang/String;I)I

    move-result v0

    sput v0, Landroid/media/AudioManager;->default_ring_vol:I

    const-string/jumbo v0, "ro.init.notification_vol"

    invoke-static {v0, v3}, Landroid/os/SystemProperties;->getInt(Ljava/lang/String;I)I

    move-result v0

    sput v0, Landroid/media/AudioManager;->default_notification_vol:I

    const-string/jumbo v0, "ro.init.alarm_vol"

    invoke-static {v0, v3}, Landroid/os/SystemProperties;->getInt(Ljava/lang/String;I)I

    move-result v0

    sput v0, Landroid/media/AudioManager;->default_alarm_vol:I

    const-string/jumbo v0, "ro.init.music_vol"

    invoke-static {v0, v6}, Landroid/os/SystemProperties;->getInt(Ljava/lang/String;I)I

    move-result v0

    sput v0, Landroid/media/AudioManager;->default_music_vol:I

    const-string/jumbo v0, "ro.init.call_vol"

    invoke-static {v0, v3}, Landroid/os/SystemProperties;->getInt(Ljava/lang/String;I)I

    move-result v0

    sput v0, Landroid/media/AudioManager;->default_voice_call:I
    ...
    sget v2, Landroid/media/AudioManager;->default_voice_call:I
    ...
    sget v2, Landroid/media/AudioManager;->default_ring_vol:I

    aput v2, v0, v1

    const/4 v1, 0x3

    sget v2, Landroid/media/AudioManager;->default_music_vol:I

    aput v2, v0, v1

    sget v1, Landroid/media/AudioManager;->default_alarm_vol:I

    aput v1, v0, v3

    const/4 v1, 0x5

    sget v2, Landroid/media/AudioManager;->default_notification_vol:I
