...
.field private static pd:Lxtreamer/app/XBusyDialog;
...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lcom/android/server/power/ShutdownThread;->pd:Lxtreamer/app/XBusyDialog;
...
.method private static beginShutdownSequence(Landroid/content/Context;)V
    ...
    :cond_9
    :try_start_8
    new-instance v5, Lxtreamer/app/XBusyDialog;

    invoke-direct {v5, p0}, Lxtreamer/app/XBusyDialog;-><init>(Landroid/content/Context;)V

    sput-object v5, Lcom/android/server/power/ShutdownThread;->pd:Lxtreamer/app/XBusyDialog;

    sget-object v5, Lcom/android/server/power/ShutdownThread;->pd:Lxtreamer/app/XBusyDialog;
    ...
    invoke-virtual {v5, v7}, Lxtreamer/app/XBusyDialog;->setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v5, v7}, Lxtreamer/app/XBusyDialog;->setMessage(Ljava/lang/CharSequence;)V

    sget-object v5, Lcom/android/server/power/ShutdownThread;->pd:Lxtreamer/app/XBusyDialog;

    const/4 v7, 0x0

    invoke-virtual {v5, v7}, Lxtreamer/app/XBusyDialog;->setCancelable(Z)V

    sget-object v5, Lcom/android/server/power/ShutdownThread;->pd:Lxtreamer/app/XBusyDialog;

    invoke-virtual {v5}, Lxtreamer/app/XBusyDialog;->getWindow()Landroid/view/Window;
    ...
    invoke-virtual {v5}, Lxtreamer/app/XBusyDialog;->show()V
    :try_end_8
...
.method public static dismissDialog()V
    ...
    sget-object v2, Lcom/android/server/power/ShutdownThread;->pd:Lxtreamer/app/XBusyDialog;
    ...
    sget-object v0, Lcom/android/server/power/ShutdownThread;->pd:Lxtreamer/app/XBusyDialog;

    if-eqz v0, :cond_0

    sget-object v0, Lcom/android/server/power/ShutdownThread;->pd:Lxtreamer/app/XBusyDialog;

    invoke-virtual {v0}, Lxtreamer/app/XBusyDialog;->dismiss()V

    const/4 v0, 0x0

    sput-object v0, Lcom/android/server/power/ShutdownThread;->pd:Lxtreamer/app/XBusyDialog;
...
.method public running()V
    ...
    invoke-virtual {v2}, Lxtreamer/app/XBusyDialog;->dismiss()V

    const/4 v2, 0x0

    sput-object v2, Lcom/android/server/power/ShutdownThread;->pd:Lxtreamer/app/XBusyDialog;
